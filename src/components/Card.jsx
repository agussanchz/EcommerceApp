...
export default function Card({ product }) {
    ...
    return (
        <div className='flex flex-col justify-between items-center p-4 border border-black rounded-xl text-slate-200 shadow-sm shadow-[#585b61be] sm:w-72 md:w-96 bg-[#9ca3af16]'>
            <Image
                src={product.imagen}
